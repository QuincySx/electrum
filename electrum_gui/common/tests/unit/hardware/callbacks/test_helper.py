...
class TestHelper(TestCase):
    @patch("electrum_gui.common.hardware.callbacks.helper.set_value_to_agent")
    @patch("electrum_gui.common.hardware.callbacks.helper.get_value_of_agent")
    @patch("electrum_gui.common.hardware.callbacks.helper.time")
